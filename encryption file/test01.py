...
if __name__ == "__main__":
    ...
    input_file = os.path.join(base_path, "test.jpg")
    encrypted_file = os.path.join(base_path, "test_encrypted.bin")
    decrypted_file = os.path.join(base_path, "test_decoded.jpg")
